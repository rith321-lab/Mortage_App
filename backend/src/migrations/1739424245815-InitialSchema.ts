...
export class InitialSchema1739424245815 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ...
            CREATE TYPE "property_type_enum" AS ENUM (
                'single_family', 'multi_family', 'condo', 'townhouse', 'mobile_home', 'other'
            );
            ...
            CREATE TYPE "loan_purpose_enum" AS ENUM (
                'purchase', 'refinance', 'cash_out_refinance', 'construction', 'other'
            );
            ...
            CREATE TYPE "employment_type_enum" AS ENUM (
                'full_time', 'part_time', 'self_employed', 'retired', 'unemployed', 'other'
            );
            
            CREATE TYPE "asset_type_enum" AS ENUM (
                'checking', 'savings', 'investment', 'retirement', 'real_estate', 'other'
            );
            
            CREATE TYPE "liability_type_enum" AS ENUM (
                'credit_card', 'car_loan', 'student_loan', 'personal_loan', 'other'
            );
            
            CREATE TYPE "document_type_enum" AS ENUM (
                'w2', 'tax_return', 'pay_stub', 'bank_statement', 'drivers_license',
            ...
            CREATE TYPE "income_frequency_enum" AS ENUM (
                'weekly', 'bi_weekly', 'semi_monthly', 'monthly', 'annual'
            );
        `);
        ...
        await queryRunner.query(`
            ...
            CREATE TABLE "mortgage_applications" (
                ...
                "loan_details_id" uuid REFERENCES "loan_details" (id),
                "metadata" jsonb,
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE IF EXISTS "liabilities" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "assets" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "employment_history" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "borrower_details" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "mortgage_applications" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "loan_details" CASCADE`);
        await queryRunner.query(`DROP TABLE IF EXISTS "properties" CASCADE`);

        // Drop types in reverse order
        await queryRunner.query(`DROP TYPE IF EXISTS "income_frequency_enum" CASCADE`);
        ...
        await queryRunner.query(`DROP TYPE IF EXISTS "liability_type_enum" CASCADE`);
        await queryRunner.query(`DROP TYPE IF EXISTS "asset_type_enum" CASCADE`);
        await queryRunner.query(`DROP TYPE IF EXISTS "employment_type_enum" CASCADE`);
        await queryRunner.query(`DROP TYPE IF EXISTS "marital_status_enum" CASCADE`);
        await queryRunner.query(`DROP TYPE IF EXISTS "loan_purpose_enum" CASCADE`);
        await queryRunner.query(`DROP TYPE IF EXISTS "loan_type_enum" CASCADE`);
        await queryRunner.query(`DROP TYPE IF EXISTS "property_type_enum" CASCADE`);
        await queryRunner.query(`DROP TYPE IF EXISTS "application_status_enum" CASCADE`);
    }
} 